    ...
    public static class Messenger
    {
            ...
            MessageBoxButtons buttons = MessageBoxButtons.OK)
        {
            ...
            var ButtonTranslations =
                GetButtonTranslations(CurrentLanguage); //<- "OK|Cancel|Yes|No|Continue|Retry|Abort"
            ...
            foreach (var _button in CmdButtons)
            {
                ...
                _button.Location = new Point(LastPos - (_button.Width + Padding),
                    (bottomPanel.Height - _button.Height) / 2);
        ...
        private static void AddTextChangedDelay<TControl>(TControl control, int milliseconds, Action<TControl> action)
        ...
        public static string GetCurrentLanguage(string pDefault = "en")
        {
            ...
            if (CurrentLanguage.ToLowerInvariant().Equals("zh"))
            {
                ...
                if (string.Equals(LangVariable, "zh-CN") || string.Equals(LangVariable, "zh-SG") ||
                    string.Equals(LangVariable, "zh-Hans"))
                {
                    _ret = "zh-Hans";
                }
                else if (string.Equals(LangVariable, "zh-TW") || string.Equals(LangVariable, "zh-HK") ||
                         string.Equals(LangVariable, "zh-MO") || string.Equals(LangVariable, "zh-Hant"))
                {
                    _ret = "zh-Hant";
                }
                else
